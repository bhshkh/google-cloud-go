...
func ArrayContainsAll(exprOrFieldPath any, values any) BooleanExpr {
	return &baseBooleanExpr{baseFunction: newBaseFunction("array_contains_all", append([]Expr{asFieldExpr(exprOrFieldPath)}, asArrayFunctionExpr(values)))}
}
...
func ArrayContainsAny(exprOrFieldPath any, values any) BooleanExpr {
	return &baseBooleanExpr{baseFunction: newBaseFunction("array_contains_any", append([]Expr{asFieldExpr(exprOrFieldPath)}, asArrayFunctionExpr(values)))}
}
...
func EqualAny(exprOrFieldPath any, values any) BooleanExpr {
	return &baseBooleanExpr{baseFunction: newBaseFunction("equal_any", append([]Expr{asFieldExpr(exprOrFieldPath)}, asArrayFunctionExpr(values)))}
}
...
func NotEqualAny(exprOrFieldPath any, values any) BooleanExpr {
	return &baseBooleanExpr{baseFunction: newBaseFunction("not_equal_any", append([]Expr{asFieldExpr(exprOrFieldPath)}, asArrayFunctionExpr(values)))}
}
