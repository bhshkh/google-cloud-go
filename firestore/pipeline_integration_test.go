...
func TestIntegration_PipelineStages(t *testing.T) {
	...
	t.Run("Update", func(t *testing.T) {
		...
		updateIter := client.Pipeline().Collection(coll.ID).Where(Equal(FieldOf("author.country"), "UK")).Update(Selectables(ConstantOf("Active").As("status"))).Execute(ctx).Results()
